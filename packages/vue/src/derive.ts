...
export function useDerived<T extends State>(state: T): Ref<T>;
export function useDerived<T extends State, R>(state: T, transform: PipeTransformer<T, R>): Ref<R>;
export function useDerived<T extends State, R>(state: T, transform?: PipeTransformer<T, R>): Ref<T | R> {
