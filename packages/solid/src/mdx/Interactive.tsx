...
export interface InteractiveProps extends JSX.HTMLAttributes<HTMLDivElement> {
  title?: string;
  icon?: JSX.Element;
...
const INTERACTIVE_INDEX = $symbol('air.mdx.interactive');
  ...
  return (
    ...
    >
      <div class="air-interactive-header">
        ...
        <div class="air-interactive-title-bar">
          <span class="air-interactive-icon" aria-hidden="true">
      ...
      <div class="air-interactive-content">{props.children}</div>
    </div>
  );
}, 'Interactive');
