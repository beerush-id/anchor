---
title: AIR Stack v1.2.22 — Reactive Browser Utilities
...
# AIR Stack v1.2.22 — Reactive Browser Utilities

**v1.2.22** — [GitHub](https://github.com/beerush-id/airstack) | [View Changes (v1.2.21...v1.2.22)](https://github.com/beerush-id/airstack/compare/v1.2.21...v1.2.22)

**AIR Stack v1.2.22** introduces a complete set of reactive browser primitives available directly from `@anchorlib/react/browser` and `@anchorlib/solid/browser`. These utilities wrap low-level DOM events into fine-grained reactive state, deferring listener registration until hydration completes via `onInteractive()` and cleaning up subscriptions automatically upon unmount.
...
```tsx [React]
import { Show } from '@anchorlib/react';
import { LIVE_NETWORK, LIVE_GEO } from '@anchorlib/react/browser';
...
```tsx [SolidJS]
import { Show } from '@anchorlib/solid';
import { LIVE_NETWORK, LIVE_GEO } from '@anchorlib/solid/browser';
...
import { setup, render } from '@anchorlib/react';
import { Show } from '@anchorlib/react';
import { LIVE_KEYBOARD, keyboardRef } from '@anchorlib/react/browser';
...
import { setup } from '@anchorlib/solid';
import { Show } from '@anchorlib/solid';
import { LIVE_KEYBOARD, keyboardRef } from '@anchorlib/solid/browser';
