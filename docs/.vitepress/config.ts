...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Posts', link: '/posts/index.html' },
      {
        ...
        items: [
          ...
          { text: 'AIR Material 3 CSS', link: '/airlib/material-css/index.html' },
    ...
    sidebar: [
      ...
      {
        text: 'AIR Material 3 CSS',
        collapsed: true,
        items: [
          { text: 'Overview', link: '/airlib/material-css/index.html' },
          { text: 'Getting Started', link: '/airlib/material-css/getting-started' },
          { text: 'Theme & Engine', link: '/airlib/material-css/theme' },
          {
            text: 'Components',
            link: '/airlib/material-css/components',
            collapsed: true,
            items: [
              { text: 'Badge', link: '/airlib/material-css/components/badge' },
              { text: 'Button', link: '/airlib/material-css/components/button' },
              { text: 'Button Group', link: '/airlib/material-css/components/button-group' },
              { text: 'Card', link: '/airlib/material-css/components/card' },
              { text: 'Checkbox', link: '/airlib/material-css/components/checkbox' },
              { text: 'Chip', link: '/airlib/material-css/components/chip' },
              { text: 'Color Picker', link: '/airlib/material-css/components/color-picker' },
              { text: 'Date Picker', link: '/airlib/material-css/components/date-picker' },
              { text: 'Dialog', link: '/airlib/material-css/components/dialog' },
              { text: 'Divider', link: '/airlib/material-css/components/divider' },
              { text: 'FAB', link: '/airlib/material-css/components/fab' },
              { text: 'FAB Menu', link: '/airlib/material-css/components/fab-menu' },
              { text: 'Icon Button', link: '/airlib/material-css/components/icon-button' },
              { text: 'Link', link: '/airlib/material-css/components/link' },
              { text: 'List', link: '/airlib/material-css/components/list' },
              { text: 'Menu', link: '/airlib/material-css/components/menu' },
              { text: 'Progress', link: '/airlib/material-css/components/progress' },
              { text: 'Radio', link: '/airlib/material-css/components/radio' },
              { text: 'Ripple', link: '/airlib/material-css/components/ripple' },
              { text: 'Search Bar', link: '/airlib/material-css/components/search-bar' },
              { text: 'Segmented Button', link: '/airlib/material-css/components/segmented-button' },
              { text: 'Select', link: '/airlib/material-css/components/select' },
              { text: 'Slider', link: '/airlib/material-css/components/slider' },
              { text: 'Snackbar', link: '/airlib/material-css/components/snackbar' },
              { text: 'Split Button', link: '/airlib/material-css/components/split-button' },
              { text: 'Switch', link: '/airlib/material-css/components/switch' },
              { text: 'Table', link: '/airlib/material-css/components/table' },
              { text: 'Text Field', link: '/airlib/material-css/components/text-field' },
              { text: 'Time Picker', link: '/airlib/material-css/components/time-picker' },
              { text: 'Tooltip', link: '/airlib/material-css/components/tooltip' },
            ],
          },
          {
            text: 'Layout',
            link: '/airlib/material-css/layout',
            collapsed: true,
            items: [
              { text: 'Accordion', link: '/airlib/material-css/layout/accordion' },
              { text: 'App Bar', link: '/airlib/material-css/layout/app-bar' },
              { text: 'Bottom Sheet', link: '/airlib/material-css/layout/bottom-sheet' },
              { text: 'Carousel', link: '/airlib/material-css/layout/carousel' },
              { text: 'Navigation Bar', link: '/airlib/material-css/layout/navigation-bar' },
              { text: 'Navigation Drawer', link: '/airlib/material-css/layout/navigation-drawer' },
              { text: 'Navigation Rail', link: '/airlib/material-css/layout/navigation-rail' },
              { text: 'Side Sheet', link: '/airlib/material-css/layout/side-sheet' },
              { text: 'Tabs', link: '/airlib/material-css/layout/tabs' },
            ],
          },
          {
            text: 'Extensions',
            link: '/airlib/material-css/extensions',
            collapsed: true,
            items: [
              { text: 'AI Interfaces', link: '/airlib/material-css/extensions/ai' },
              { text: 'Masonry', link: '/airlib/material-css/extensions/masonry' },
              { text: 'Skeleton', link: '/airlib/material-css/extensions/skeleton' },
            ],
          },
          {
            text: 'Utilities',
            link: '/airlib/material-css/utilities',
            collapsed: true,
            items: [
              { text: 'State', link: '/airlib/material-css/utilities/state' },
              { text: 'Typography', link: '/airlib/material-css/utilities/typography' },
            ],
          },
        ],
      },
