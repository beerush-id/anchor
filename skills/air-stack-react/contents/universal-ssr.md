...
```ts
import { createWorker, createSSR } from '@airlib/react/ssr';
import router from './lib/router.js';
import RootLayout from './pages/layout.js';
...
```ts
```ts
import { createWorker, createSSR, defaultAssetResolver } from '@airlib/react/ssr';
import router from './lib/router.js';
import RootLayout from './pages/layout.js';
...
```ts
import { createFullWorker, createSSR, defaultAssetResolver } from '@airlib/react/ssr';
import { HTTPRouter } from '@irpclib/http/router';
import { irpc, transport } from './lib/module.js';
import router from './lib/router.js';
import RootLayout from './pages/layout.js';
...
import { createSSR } from '@airlib/react/ssr';
...
import { createSSR } from '@airlib/react/ssr';
import { HTTPRouter } from '@irpclib/http/router';
import { decodeCookies, setCookieContext } from '@airlib/react';
