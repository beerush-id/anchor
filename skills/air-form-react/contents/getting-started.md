...
export const SignUp = setup(() => {
  ...
  return render(() => (
    <SignUpForm onSubmit={handleSubmit}>
      <SignUpForm.Field name="name" label="Name" errorClass="error">
      ...
      <SignUpForm.Field name="password" label="Password" errorClass="error">
        <PasswordInput />
      </SignUpForm.Field>
...
export const ProfileEditor = template<{ user: User }>((props) => (
  ...
  >
    <ProfileForm.Field name="name" label="Name" errorClass="error">
      <TextInput placeholder="Enter name" />
    </ProfileForm.Field>

    <ProfileForm.Field name="email" label="Email" errorClass="error">
      <EmailInput placeholder="Enter email" />
    </ProfileForm.Field>

    <ProfileForm.Field name="age" label="Age" errorClass="error">
      <NumberInput />
    </ProfileForm.Field>
