...
3. **Peer Dependencies**: List `@airlib/core` or `@airlib/solid` as `peerDependencies` instead of `dependencies` to prevent multiple versions of reactivity engines from running simultaneously in the consumer's app.
