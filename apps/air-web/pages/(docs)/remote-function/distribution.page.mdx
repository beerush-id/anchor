...
nav-priority: 67
title: 'Distribution'
description: 'IRPC distribution — packages, microservice routing, NPM publishing, edge distribution, dynamic transport switching, and monitoring.'
---
...
The [Overview](/docs/remote-function) mentioned transport agnosticism and edge distribution as architectural superpowers. This page goes deep into the **mechanics** of each pattern and how to implement them.
