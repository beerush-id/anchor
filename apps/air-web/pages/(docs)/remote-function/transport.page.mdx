...
nav-priority: 65
title: 'Transports'
description: 'IRPC transports — HTTP, WebSocket, BroadcastChannel, custom transports, routing, stream lifecycle, and context management.'
---
...
The [Overview](/docs/remote-function) introduced transport agnosticism as an architectural superpower. This page goes deep into **how** each transport works, **when** to choose which, and **how** to build your own.
