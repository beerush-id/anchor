...
description: 'Define and execute isomorphic remote functions with IRPC — declarations, handlers, reactive streaming, and standardized CRUD.'
---
...
The AirLib solves this with **IRPC**: a universal reactive network abstraction. 
...
The true power of IRPC in the AirLib is its ability to handle **continuous data streams** using the exact same architecture.
...
:::info[Ready for more?]
Read the [CRUD Deep Dive](/docs/remote-function/crud) for advanced topics like driver implementations, caching chains, and operation exclusions.
:::
