...
```tsx [React]
import { setup, mutable, effect } from '@airlib/react';
...
```tsx [React]
import { effect, untrack } from '@airlib/react';
...
```tsx [SolidJS]
import { effect, untrack } from '@airlib/solid';
...
```tsx [React]
import { snapshot, effect } from '@airlib/react';
...
```tsx [SolidJS]
import { snapshot, effect } from '@airlib/solid';
...
```tsx [React]
import { stringify, effect } from '@airlib/react';
...
```tsx [SolidJS]
import { stringify, effect } from '@airlib/solid';
...
```tsx [React]
import { mutable, subscribe } from '@airlib/react';
...
```tsx [SolidJS]
import { mutable, subscribe } from '@airlib/solid';
...
```tsx [React]
import { effect, awaited } from '@airlib/react';
...
```tsx [SolidJS]
import { effect, awaited } from '@airlib/solid';
...
```tsx [React]
import { effect, snapshot } from '@airlib/react';
...
```tsx [SolidJS]
import { effect, snapshot } from '@airlib/solid';
