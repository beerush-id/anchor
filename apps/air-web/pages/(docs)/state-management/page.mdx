---
nav: 'Overview'
nav-icon: data-object
nav-priority: 80
title: "State Management"
description: "Universal fine-grained reactivity for modern web applications — standard JavaScript objects with automatic dependency tracking."
keywords:
  - state management
  - reactivity
  - anchor core
...
- [Mutable State](/docs/state-management/mutable) - Deep dive into creating and modifying reactive state.
- [Immutable State](/docs/state-management/immutable) - Working with read-only state references.
- [Derived State](/docs/state-management/derived) - Creating computed values that update automatically.
- [Form Handling](/docs/state-management/form-handling) - Validating data with Zod schemas.
- [Side Effects](/docs/state-management/side-effect) - Running code automatically on data changes.
- [Async Handling](/docs/state-management/async-handling) - Loading data and managing asynchronous states.
- [Advanced Patterns](/docs/state-management/advanced) - Architectural guidelines for scoping state.
