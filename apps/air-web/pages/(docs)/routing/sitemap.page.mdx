---
nav: 'Sitemap Generation'
nav-priority: 95
title: 'Sitemap Generation'
description: "Anchor's built-in XML sitemap generator — static and dynamic routes, multi-language alternates, and programmatic generation."
---
