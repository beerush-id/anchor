---
title: 'Usage'
description: 'Anchor storage modules — session, persistent, IndexedKV, and IndexedTable.'
nav: 'Usage'
nav-priority: 201
---
...
Before getting started with Anchor's storage modules, ensure you have followed the [installation](/docs/storage/getting-started) instructions. This guide will provide a comprehensive introduction to each storage functionality.
