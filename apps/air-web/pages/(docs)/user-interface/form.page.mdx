...
description: 'User-driven form components in the AirLib with built-in validation, restoring the natural HTML form model with reactive state.'
nav: 'Form Components'
nav-priority: 105
---
...
In the AirLib, **events are an opt-in side effect**. Inputs should own their **two-way bindings directly**. A parent component shouldn't need an **imperative `onChange` handler** just to make an input work.
...
```tsx [React]
import { setup, setContext, form } from '@airlib/react';
...
```tsx [SolidJS]
import { setup, setContext, form } from '@airlib/solid';
import { FormContext } from './context';
...
```tsx [React]
import { setup, derived, getContext, setContext, $use } from '@airlib/react';
...
```tsx [SolidJS]
import { setup, getContext, setContext } from '@airlib/solid';
import { FormContext, FieldContext } from './context';
...
```tsx [React]
import { setup, getContext, derived } from '@airlib/react';
import { FormContext, FieldContext } from './context';
...
```tsx [SolidJS]
import { setup, getContext, derived } from '@airlib/solid';
import { FormContext, FieldContext } from './context';
...
```tsx [React]
import { setup, setContext, getContext, form, derived } from '@airlib/react';
import { FormContext, FieldContext } from './context';
...
```tsx [SolidJS]
import { setup, setContext, getContext, form } from '@airlib/solid';
import { FormContext, FieldContext } from './context';
import type { ZodSchema, z } from 'zod';
