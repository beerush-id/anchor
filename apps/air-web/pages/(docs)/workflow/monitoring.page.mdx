...
:::code-group
```typescript [React]
import { WORKFLOW_STORE } from '@airlib/react';
...
```typescript [SolidJS]
import { WORKFLOW_STORE } from '@airlib/solid';
...
- **[Plan & Recover](/docs/workflow/plan)**: Revisit the foundational pipeline primitives.
