...
nav: 'Branching'
nav-priority: 74
title: 'Workflow Branching Logic'
...
- **[Observability & Monitoring](/docs/workflow/monitoring)**: Learn how to instantly build reactive telemetry dashboards for your workflows.
- **[Plan & Recover](/docs/workflow/plan)**: Understand the core pipeline orchestration primitives.
