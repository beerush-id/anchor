...
description: 'Install and set up AirLib Material 3 CSS in your Tailwind v4 project.'
nav: 'Getting Started'
nav-priority: 121
---
...
AirLib Material 3 CSS is designed to work seamlessly as a theme and headless component library for Tailwind CSS v4.
...
```bash [Yarn] name="yarn"
yarn add @airlib/material tailwindcss
```
