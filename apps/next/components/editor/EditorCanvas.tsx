  ...
  return (
    <div ref={ref} className="flex flex-col flex-1 relative">
      ...
      <ToggleGroup className="absolute bottom-4 right-4">
        <Toggle bind={viewWriter} name="viewMode" value="canvas" className="ark-toggle-button">
          <SquareMousePointer size={TOOL_ICON_SIZE} />
          <Tooltip>Canvas View</Tooltip>
        </Toggle>
        <Toggle bind={viewWriter} name="viewMode" value="code" className="ark-toggle-button">
          <SquareDashedBottomCode size={TOOL_ICON_SIZE} />
          <Tooltip>CSS View</Tooltip>
        </Toggle>
        <Toggle bind={viewWriter} name="viewMode" value="json" className="ark-toggle-button">
