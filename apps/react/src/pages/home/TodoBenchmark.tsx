    ...
    <>
      <Section id="todo-benchmark" className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 min-h-screen">
        ...
        <SectionDescription className="text-center mt-4 max-w-4xl mx-auto">
          This demo is built with profiling enabled, allowing you to use React DevTools to verify the benchmark data,
          analyze render times, and see how Anchor's fine-grained reactivity prevent re-renders, while a classic
          approach can cause performance to degrade as the app scales.{' '}
        </SectionDescription>
        ...
        <blockquote className="mt-12 text-center max-w-3xl mx-auto text-lg italic text-slate-400 leading-relaxed">
          "A well-engineered app stays performant whether it's displaying one item or hundreds. Its performance doesn't
