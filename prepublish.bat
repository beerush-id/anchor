...
bpkg info set dependencies.@anchorlib/core="^%VERSION%" -f packages/storage packages/react packages/router packages/react-classic packages/solid packages/svelte packages/vue irpclib/irpc
